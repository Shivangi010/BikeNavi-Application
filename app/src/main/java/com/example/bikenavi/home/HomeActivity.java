...
public class HomeActivity extends AppCompatActivity {
    ...
    private static BluetoothSocket object;

    public static void setData(BluetoothSocket object){
        HomeActivity.object = object;
    }

    public static BluetoothSocket getData(){
        return object;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        obj = SingleToneClass.getInstance();
